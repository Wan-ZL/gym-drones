...
def att_def_interaction(defender_model, attacker_model):
    ...
    writer = SummaryWriter("/Users/wanzelin/办公/gym-drones/train_drl_vs_drl/runs_att_def_interaction/each_run_" +str(start_time) + "drl_vs_drl")
    ...
    for episode in range(config['episode']):
        ...
        while not done:
            ...
            observation_new, reward_def, reward_att, done, info = env.step(action_def=action_def, action_att=action_att)
            ...
            defender_model.remember(observation, action_def, reward_def)
            ...
            # after collect 5 memory, train the model,and clear memory.
            attacker_model.remember(observation, action_att, reward_att)
            if step_counter % 5 == 0 or done:
